    ...
    <section id="hero" className="relative min-h-[90vh] flex items-center pt-24 md:pt-20 overflow-hidden bg-[#0B0F19]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          ...
          {/* RIGHT COLUMN */}
          <div className="lg:col-span-5 order-2 flex justify-start w-full pt-4 lg:pt-0 select-none">
            <motion.div
            ...
            >
              {/* BORDER FRAME */}
              <div className={`absolute inset-0 rounded-2xl border-2 transition-all duration-300 ease-out pointer-events-none
      ${isImgActive
                  ? "translate-x-[22px] translate-y-[22px] border-[#D8B79A]"
                  : "translate-x-[16px] translate-y-[16px] border-[#D8B79A]/30 lg:group-hover:translate-x-[22px] lg:group-hover:translate-y-[22px] lg:group-hover:border-[#D8B79A]"
                }`}
              />

              {/* IMAGE CONTAINER */}
              <div className={`relative w-full h-full rounded-2xl overflow-hidden bg-[#0B0F19] border border-white/[0.08] shadow-2xl transition-all duration-300 ease-out pointer-events-none
      ${isImgActive
          ...
          ${isImgActive
                      ...
                      : "grayscale opacity-75 mix-blend-luminosity lg:group-hover:filter-none lg:group-hover:opacity-100 lg:group-hover:mix-blend-normal"
                    }`}
                />
